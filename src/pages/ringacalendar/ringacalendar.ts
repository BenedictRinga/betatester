...
import { CalAddEventPage } from '../cal-add-event/cal-add-event';
...
@IonicPage()
@Component({
  selector: 'page-ringacalendar',
  templateUrl: 'ringacalendar.html',
})
export class RingacalendarPage {
  date: any;
  daysInThisMonth: any;
  daysInLastMonth: any;
  daysInNextMonth: any;
  ...
  addEvent() {
    this.navCtrl.push(CalAddEventPage);
  }
  loadEventThisMonth() {
